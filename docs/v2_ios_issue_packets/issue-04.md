...
## Why
This packet tracks implementation details, test evidence, and commit history for Issue 4.
...
Refer to docs/v2_ios_github_issues.md for the canonical acceptance criteria for Issue 4.

## Evidence
- Branch/commit: Signal-iOS-Archive v2_ios @ 89e159a02d (Issue 4: implement deterministic monthly chunk planner)
